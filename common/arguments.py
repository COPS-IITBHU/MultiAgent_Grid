...
def get_args():
    ...
    parser.add_argument("--max-episode-len", type=int, default=8, help="maximum episode length")#Set to 1 to accomodate Hierarchal training
    parser.add_argument("--time-steps", type=int, default=20000*8, help="number of time steps")#For Hierarchal -> Number of episodes
    ...
    parser.add_argument("--evaluate-episode-len", type=int, default=8, help="length of episodes for evaluating")
    parser.add_argument("--evaluate", type=bool, default=False, help="whether to evaluate the model")
    parser.add_argument("--evaluate-rate", type=int, default=1000*8, help="how often to evaluate model")
